        ...
        <div className='container '>
          <div className='row productList productMobile'>
            <div className=' text-center productCard col-md-3 '>
              ...
              <h4 className='month '> ₹500/month</h4>
            ...
            <div className=' text-center productCard col-md-3 '>
              ...
              <p className='startingFrom'>Starting from</p>
              <h4 className='month'> ₹300/month</h4>
              <Link className='buy btn btn-lg btn-block ' to='/insure'>
                Quote
              </Link>
            </div>
            <div className=' text-center productCard col-md-3 '>
              ...
              <p className='startingFrom'>Starting from</p>
              <h4 className='month'> ₹100/month</h4>
              <Link className='buy btn btn-lg btn-block ' to='/insure'>
                Quote
              </Link>
            </div>
          ...
          <div className='row productList '>
            <div className=' text-center productCard col-md-3'>
              ...
              <p className='startingFrom '>Starting from</p>
              <h4 className='month '> ₹1500/month</h4>
              <Link className='buy btn btn-lg btn-block ' to='/insure'>
                Quote
              </Link>
            </div>
            <div className=' text-center productCard col-md-3'>
              ...
              <p className='startingFrom'>Starting from</p>
              <h4 className='month'> ₹1000/month</h4>
              <Link className='buy btn btn-lg btn-block ' to='/insure'>
                Quote
              </Link>
            </div>
            <div className=' text-center productCard col-md-3'>
              ...
              <p className='startingFrom'>Starting from</p>
              <h4 className='month'> ₹3000/trip</h4>
              <Link className='buy btn btn-lg btn-block ' to='/insure'>
                Quote
              </Link>
            </div>
